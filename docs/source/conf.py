...
latex_documents = [
    (master_doc, 'modio.tex', 'mod.io Documentation',
     'Clement Julia', 'manual'),
]
...
man_pages = [
    (master_doc, 'modio', 'mod.io Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'modio', 'mod.io Documentation',
     author, 'modio', 'One line description of project.',
     'Miscellaneous'),
]
