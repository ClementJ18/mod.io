...
class Comment:
    ...
    async def delete(self):
        ...
        r = await self._client._delete_request(f'/games/{self._mod.game}/mods/{self._mod.id}/comments/{self.id}')
        return r
...
class ModFile:
    ...
    async def edit(self, **fields):
        ...
        file_json = await self._client._put_request(f'/games/{self._game_id}/mods/{self.mod_id}/files/{self.id}', data = fields)
...
class TeamMember(User):
    ...
    async def edit(self, *, level=None, position=None):
        ...
        msg = await self._client._put_request(f'/games/{self._mod.game}/mods/{self._mod.id}/team/{self.team_id}', data=data)
        return Message(**msg)
    ...
    async def delete(self):
        ...
        This function is a coroutine."""
        r = await self._client._delete_request(f'/games/{self._mod.game}/mods/{self._mod.id}/team/{self.team_id}')
        return r
